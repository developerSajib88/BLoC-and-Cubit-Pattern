...
class ProductScreenCubit extends StatefulWidget {
  const ProductScreenCubit({super.key});

  @override
  State<ProductScreenCubit> createState() => _ProductScreenCubitState();
}

class _ProductScreenCubitState extends State<ProductScreenCubit> {
  @override
  void initState() {
